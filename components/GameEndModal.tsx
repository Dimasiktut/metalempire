...
const GameEndModal: React.FC<GameEndModalProps> = ({ winner, onNewGame }) => {
  return (
    <div className="absolute inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center z-50">
      ...
      >
        <h2 className="font-bebas text-6xl text-yellow-400 mb-4 tracking-wider" style={{ textShadow: '0 0 10px #facc15' }}>Игра окончена!</h2>
        ...
        <button
          onClick={onNewGame}
          className="bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bebas text-2xl tracking-wider py-3 px-8 rounded-lg shadow-lg hover:shadow-blue-500/50 transition-all transform hover:scale-105"
        >
          Новая игра
        </button>
      </div>
